...
/**
 * Perform actions while starting a web application
 * @author Florent Benoit
 */
@Processor
@Phase("PRE_INJECTION")
public class EJB3InWarStartProcessor {
    ...
    public void handle(EJB3 ejb3, ProcessorContext processorContext) throws ProcessorException {
        ...
        Thread.currentThread().setContextClassLoader(EJB3InWarStartProcessor.class.getClassLoader());
        try {
